...
def create_callbacks(model, training_model, prediction_model, validation_generator, args):
    ...
    if args.evaluation and validation_generator:
        evaluation = Evaluate(validation_generator, tensorboard=tensorboard_callback, save_map_path='./logs/mAP_stat_resnet152.txt')
...
if __name__ == '__main__':
    ...
    params = [
        # '--snapshot', './snapshots/resnet152_oid_239.h5',
        '--imagenet-weights',
        '--gpu', '0',
        '--steps', '10000',
        # '--multi-gpu', '2',
