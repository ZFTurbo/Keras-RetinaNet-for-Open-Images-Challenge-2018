...
if __name__ == '__main__':
    params = [
        '../retinanet_level_1/snapshots/resnet101_oid_274.h5',
        '../retinanet_level_1/snapshots/resnet101_oid_274_converted.h5',
        '--backbone', 'resnet101'
    ]
    params = [
        '../retinanet_level_1/snapshots/resnet152_oid_262.h5',
        '../retinanet_level_1/snapshots/resnet152_oid_262_converted.h5',
        '--backbone', 'resnet152'
    ]
    main(params)
